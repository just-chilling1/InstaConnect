...
const _schema = i.schema({
  entities: {
    ...
    profiles: i.entity({
      ...
      muteLikeNotifications: i.boolean().optional(),
      muteCommentNotifications: i.boolean().optional(),
      muteFollowNotifications: i.boolean().optional(),
      muteMessageNotifications: i.boolean().optional(),
    ...
    reports: i.entity({
      ...
      reason: i.string(),
      status: i.string().indexed(), // "pending" | "reviewed"
      createdAt: i.number().indexed(),
    }),
  ...
  links: {
    ...
    bookmarkUser: {
      forward: { on: "bookmarks", has: "one", label: "user" },
      reverse: { on: "$users", has: "many", label: "bookmarks" },
    },
    bookmarkPost: {
      forward: { on: "bookmarks", has: "one", label: "post" },
      reverse: { on: "posts", has: "many", label: "bookmarks" },
    },

    reportReporter: {
      forward: { on: "reports", has: "one", label: "reporter" },
      reverse: { on: "$users", has: "many", label: "reports" },
    },
    reportPost: {
      forward: { on: "reports", has: "one", label: "post" },
      reverse: { on: "posts", has: "many", label: "reports" },
    },
    reportComment: {
      forward: { on: "reports", has: "one", label: "comment" },
      reverse: { on: "comments", has: "many", label: "reports" },
    },
    reportUser: {
      forward: { on: "reports", has: "one", label: "reportedUser" },
      reverse: { on: "$users", has: "many", label: "reportedIn" },
    },
  },
});
