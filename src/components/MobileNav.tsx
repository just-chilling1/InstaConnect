          ...
          <SheetContent side="left">
            <SheetHeader>
              <SheetTitle className="flex items-center gap-2">
                <BrandMark className="w-6 h-6 text-accent" />
                InstaConnect
              </SheetTitle>
            </SheetHeader>
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {item.label}
                    {item.badge && (
                      <span className="absolute left-6 top-1.5 min-w-[16px] h-4 px-1 rounded-full bg-accent text-accent-text text-[10px] font-mono font-medium flex items-center justify-center">
                        {item.badge}
                      </span>
                    )}
                  </Link>
